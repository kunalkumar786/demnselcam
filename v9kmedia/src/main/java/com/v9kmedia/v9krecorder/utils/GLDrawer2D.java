...
public class GLDrawer2D {
	...
	public static int loadShader(final String vss, final String fss) {
		...
		if (compiled[0] == 0) {
			 if(DEBUG) Log.d(TAG, "Failed to compile vertex shader:"
		...
		if (compiled[0] == 0) {
			 if(DEBUG) Log.d(TAG, "Failed to compile fragment shader:"
