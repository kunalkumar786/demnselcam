...
public class Constant {
	...
	public final static String FILE_START_NAME = "snap_dezzy_";
	public final static String VIDEO_EXTENSION = ".mp4";
	public final static String MP4_AUDIO_EXTENSION = ".m4a";
	public final static String MP3_AUDIO_EXTENSION = ".mp3";
	public final static String RAW_AUDIO_EXTENSION = ".pcm";
	public final static String IMAGE_EXTENSION = ".jpg";
	public final static String DCIM_FOLDER = "/DCIM";
    public final static String DIR_NAME = "Snapshot";
	public final static String CAMERA_FOLDER = "/video";
	public final static String TEMP_FOLDER = "/Temp";
	public final static String CAMERA_FOLDER_PATH = Environment.getExternalStorageDirectory().toString() + Constant.DCIM_FOLDER + Constant.CAMERA_FOLDER;
	public final static String TEMP_FOLDER_PATH = Environment.getExternalStorageDirectory().toString() + Constant.DCIM_FOLDER + Constant.CAMERA_FOLDER + Constant.TEMP_FOLDER;
